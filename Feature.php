    ...
    *********************************************************************************************************************************************************** -->
    ...
    <section id="main-content">
        <section class="wrapper site-min-height">
            <h3><i class="fa fa-angle-right"></i> Mark your Star</h3>
                ...
                <div class="col-lg-12 main-chart">
                    ...
                    <div class="content-panel">
                        ...
                        <table id="container" class="table">
                            ...
                            $stmt = $db->query('SELECT id, title, subject,star FROM arts ORDER BY id DESC');
                            ...
                            echo '<td>'.$row['subject'].'</td>';
                                ?>
                                <td>
                                    <a><input class="fa-star " type="checkbox" value='<?php echo $row['star'];?>'></a>
                                </td>
                        ...
                        <h3 style="margin-left: 506px;"><input class="btn btn-round btn-default" type='submit' name='submit' value="Make Star"></h3>
