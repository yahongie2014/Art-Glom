            ...
            <div class="row">
                <div class="col-lg-12 main-chart">
                    ...
                    <div class="content-panel">
                        ...
                        <table id="container" class="table">                            <tr>
                                <th>Username</th>
                                <th>Email</th>
                                <th>Action</th>
                            </tr>
                            ...
                            try {
                                ...
                                while($row = $stmt->fetch()){
                                    ...
                                    <td>
                                        <a class="btn btn-primary btn-xs" href="change.php?id=<?php echo $row['memberID'];?>">Edit</a>
                                        <?php if($row['memberID'] != 1){?>
                                            | <a class="btn btn-danger btn-xs" href="javascript:deluser('<?php echo $row['memberID'];?>','<?php echo $row['username'];?>')">Delete</a>
                                        <?php } ?>
                                    </td>
